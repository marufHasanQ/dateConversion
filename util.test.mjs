...
test('checks if non leapyear february is 28 days', function () {
    expect(nonLeapYearComparisonArray.at(59)[0] === 3 && nonLeapYearComparisonArray.at(59)[1] === 1).toBeTruthy();
});

test('checks if leapyear february is 29 and day is added in right position', () => {
